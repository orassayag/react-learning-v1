...
class ContactData extends Component {
    state = {
        orderForm: {
            ...
            zipCode: this.createInput('input', 'text', 'Zip code'),
            country: this.createInput('input', 'text', 'Country'),
            email: this.createInput('input', 'email', 'Your Email'),
            deliveryMethod: this.createInput('select', 'email', 'Your Email', '', false, ['fastest', 'cheapest']),
        },
        formIsValid: false,
        loading: false
    }

    createInput(inputType, type, placeholder, value = '', shouldValidate = true, options = '', required = true, minLength = 5, maxLength = 50) {
